...
class SQLIPS 
{
	 ...
	 */
	public long adicionarIPS (PersistenceManager pm, long id, String nombre, String localizacion, long idEPS) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaIPS () + "(id, nombre, localizacion, idEPS) values (?, ?, ?, ?)");
        q.setParameters(id, nombre, localizacion, idEPS);
