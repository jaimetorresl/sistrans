...
import uniandes.isis2304.epsandes.negocio.VOAdministradorEPS;
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			VOBebida bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOBebida bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			VOAdministradorEPS bar1 = parranderos.adicionarBar ("Los Amigos", "Bogotá", "Bajo", 2);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			
			List <VOTipoBebida> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOBebida> listaBebidas1 = parranderos.darVOBebidas();
			List <VOAdministradorEPS> bares = parranderos.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOAdministradorEPS> lista = parranderos.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			VOAdministradorEPS bar1 = parranderos.adicionarBar ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOAdministradorEPS bar2 = parranderos.adicionarBar ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOAdministradorEPS bar3 = parranderos.adicionarBar ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOAdministradorEPS bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			...
			List <VOTipoBebida> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOBebida> listaBebidas = parranderos.darVOBebidas ();
			List <VOAdministradorEPS> listaBares = parranderos.darVOBares ();
			List <VOSirven> listaSirven = parranderos.darVOSirven ();
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			List <VOAdministradorEPS> listaBares2 = parranderos.darVOBares ();
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOConsulta bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsulta bdor2 = parranderos.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOConsulta bdor3 = parranderos.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOConsulta> bebedores = parranderos.darVOBebedores();
			VOConsulta bdor5 = parranderos.darBebedorPorId(bdor1.getId ());
			VOConsulta bdor6 = parranderos.darBebedorPorId(0);
			List <VOConsulta> pepitos = parranderos.darVOBebedoresPorNombre("Pepito");
			List <VOConsulta> pedritos = parranderos.darVOBebedoresPorNombre("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			VOConsulta bdor2 = parranderos.darBebedorCompleto(bdor1.getId ());
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOConsulta> bebedores1 = parranderos.darVOBebedores ();
			long bebedoresActualizados = parranderos.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOConsulta> bebedores2 = parranderos.darVOBebedores ();
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOAdministradorEPS bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOConsulta bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsulta bdor2 = parranderos.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOConsulta bdor3 = parranderos.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOConsulta bdor4 = parranderos.adicionarBebedor ("Luis", "Cartagena", "Medio");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOAdministradorEPS bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOConsulta bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsulta bdor2 = parranderos.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOConsulta bdor3 = parranderos.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
...
//			e.printStackTrace();
    ...
    public void demoGustan ( )
    {
		try 
		{
			...
			List <VOTipoBebida> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOBebida> listaBebidas = parranderos.darVOBebidas ();
			List <VOConsulta> listaBebedores = parranderos.darVOBebedores ();
			List <VOGustan> listaGustan = parranderos.darVOGustan();
			long gustanEliminados = parranderos.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = parranderos.eliminarBebidaPorNombre ("120");
			long tbEliminados = parranderos.eliminarTipoBebidaPorNombre ("Vino tinto");
...
//			e.printStackTrace();
     ...
     */
    private String listarBebedores (List<VOConsulta> lista) 
    {
    	String resp = "Los bebedores existentes son:\n";
    	int i = 1;
        for (VOConsulta bdor : lista)
        {
     ...
     */
    private String listarBares (List<VOAdministradorEPS> lista) 
    {
    	String resp = "Los bares existentes son:\n";
    	int i = 1;
        for (VOAdministradorEPS bar : lista)
        {
        	resp += i++ + ". " + bar.toString() + "\n";
        }
        return resp;
    ...
    private String listarBebedorYNumVisitas (List<Object[]> lista) 
    {
        ...
        {
			VOConsulta bdor = (VOConsulta) tupla [0];
