...
class SQLPaciente 
{
	 ...
	 */
	public UsuarioIPS darPacientePorId (PersistenceManager pm, long id) 
	{
	 ...
	 */
	public List<UsuarioIPS> darPacientePorNombre (PersistenceManager pm, String nombre) 
	{
	 ...
	 */
	public List<UsuarioIPS> darBares (PersistenceManager pm)
	{
